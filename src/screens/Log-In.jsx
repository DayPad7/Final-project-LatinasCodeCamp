...
const Login = (props) => {
  ...
  const renderErrortxt = (text) => {
    return text != "" && <p className="error_msg"> {text} </p>;
  };
  ...
  return (
    <>
          ...
          <form onSubmit={handleSubmitPopup}>
            <label className="block" htmlFor="pin">
              ...
              <div className=" text-center text-red-600 ">
                {errorPin &&
                  renderErrortxt(
                    "⚠️ Algo esta mal! Por favor ingresa nuevamente tu PIN ⚠️"
                  )}{" "}
              </div>
            </label>
            ...
            <button
              type="submit"
              className=" w-40 font-medium text-xl rounded-md py-3  bg-red-300 hover:bg-red-400 ..."
            >
              {" "}
              Continuar{" "}
            </button>
      ...
      <section className=" flex flex-col text-center h-full w-full">
        <h1 className="text-4xl font-bold text-center text-red-400 tracking-wide py-7">
          Login
        </h1>
        <form onSubmit={handleSubmit}>
          <label className="block" htmlFor="fullname">
            ...
            <input
              ...
              type="fullname"
              className="mt-1 px-3 py-2 bg-white shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 rounded-md sm:text-sm focus:ring-1 "
              placeholder="Ejemplo: Tu Nombre Completo Acá"
              id="fullname"
              name="fullname"
            />
            <div className=" text-center text-red-600 ">
              ...
              {errorName &&
                renderErrortxt(
                  "⚠️ Por favor ingresa tu Nombre Completo ⚠️"
                )}{" "}
            </div>
          </label>
          ...
          <label className="block" htmlFor="username">
            ...
            <input
              ...
              type="username"
              className="mt-1 px-3 py-2 bg-white shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 rounded-md sm:text-sm focus:ring-1 "
              placeholder="Ejemplo: Username87"
              id="username"
              name="username"
            />
            <div className=" text-center text-red-600 ">
              {" "}
              {errorUsername &&
                renderErrortxt(" ⚠️ Por favor ingresa tu Username ⚠️ ")}
            </div>
          </label>
