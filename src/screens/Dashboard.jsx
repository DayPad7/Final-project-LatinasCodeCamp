...
<section className="  text-1xl font-normal py2">
    ...
    <p> 
    Actualmente cuentas con los siguientes tipos de acciones </p>
  
    <p className='text-2xl font-medium '> 
      {props.stocks.name}  </p>
      <p>Acciones: {props.stocks.usershare} </p>
      <p> Valor por Accion: USD {props.stocks.price}</p>
      <p> Equivalente de tus acciones en USD : {props.stocks.price * props.stocks.usershare} </p>
...
<img className=' w-20 ' src="https://www.gran-turismo.com/gtsport/decal/4827871999580702208_1.png" alt="" />
    </div>
    
    <br></br>
    <br></br>

<button onClick={imprimirEstado} className='text-red-400' > Imprimir</button>
