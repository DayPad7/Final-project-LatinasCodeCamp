  ...
  return (
    <>
      ...
      <section className=" flex flex-col text-center h-full w-full m-10 ">
        <h3 className="text-2xl font-bold text-center text-red-400 tracking-wide py-1">
          Cambio de PIN
        </h3>
        <p className=" block text-lg font-medium py-2">
          Completa los siguientes espacios para cambiar tu PIN
        </p>

        <form onSubmit={handleSubmitPinChange}>
          <label className="block" htmlFor="actualpin">
            <span className=" block text-lg font-medium">Ingresa tu PIN</span>
