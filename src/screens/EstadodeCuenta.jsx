...
<section className=" flex flex-col text-center h-full w-full m-10 ">
      ...
      <h3 className=' text-center text-lg font-medium text-slate-700'> Monto en USD = {props.initialCash}</h3>
...
type="number" className="  mt-1 px-3 py-2 bg-white shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 rounded-md sm:text-sm focus:ring-1 " placeholder=' 3000 ' />
       </label>
       <br></br>
